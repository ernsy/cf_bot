...
CfBot.CC.start_valr(0.31675336, "hodl")
CfBot.Statem.set_mode(CfValr, "sell")
CfBot.Statem.set_hodl_amt(CfValr, "primary", 0.48225945)
CfBot.Statem.set_sell_amt(CfValr, 0.14882239)
